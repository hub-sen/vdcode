define(function () {
    function _(_, i, a, n, m) {
        var l, c, s, o = e[_];
        if (a === n) return l = t(i, o.calc[a]), c = l[1], s = l[2] || "", {
            num: m ? i : x(i),
            unitFirst: c,
            unitSecond: s ? s : ""
        };
        var p = t(i, o.init[a]),
            r = o.special && o.special[a + "-" + n] || null;
        return l = r ? t(i, r) : t(new Function("return " + p[0])(), o.calc[n]), i = new Function("return " + l[0])(), c = l[1], s = l[2] || "", {
            num: m ? i : x(i),
            unitFirst: c,
            unitSecond: s ? s : ""
        }
    ...
    function x(_) {
        ...
        if (l.indexOf(".") > -1) {
            var s = l.match(/\.\d+e[+-](\d+)$/);
            c = s && s[1] ? 1 * s[1] < a - 1 ? !0 : !1 : !0
        }
        return c ? _ > -1 && 1 > _ && 0 != _ ? _ = Math.abs(_) < 1e-5 ? i(_, m) : 1 * _.toFixed(n) : (x = l.split("."), t = x[0], e = x[1], l.length > a ? _ = t.length >= a ? i(_, m) : t.length < n - 1 ? 1 * _.toFixed(n) : 1 * _.toFixed(a - t.length - 1) : e.length > n && (_ = 1 * _.toFixed(n))) : l.length > a && (_ = i(_, m)), _ + ""
    }

    function t(_, x) {
        return x.replace("x", _).split("_")
    }

    function i(_, x) {
        var t = _.toExponential(x);
        return (t + "").match(new RegExp(".0{" + x + "}e")) ? _.toExponential(0) : t
    }
    var a = 14,
        n = 7,
        m = 4,
        e = {
            ...
            length: {
                ...
                group: [{
                    ...
                    name: "英制",
                    list: ["英寸_(in)", "inch_(in)", "英尺_(ft)", "码_(yd)", "英里_(mi)", "海里_(nmi)", "英寻_(fm)", "弗隆_(fur)"]
                }, {
                    name: "市制",
                    list: ["里", "丈", "尺", "寸", "分", "厘", "毫"]
                }]
    ...
    return {
        getLength: function (_) {
            for (var x, t = 0, i = 0; x = e[_].group[i]; i++) t += x.list.length;
            return t
        },
        getData: function (_) {
            return e[_]
        },
        calc: function (x, t, i, a) {
            return _(x, t, i, a)
        },
        calcOrigin: function (x, t, i, a) {
            return _(x, t, i, a, !0)
        },
        format: function (_) {
            return x(_)
